...
public class RefExam_01 {
	...
	public static void main(String[] args) {
		...
		String name = "이왕재";
		// =오른쪽이 먼저 실행 됨
		// "이왕재"를 heap영역에 할당하면 번지 획득
		// stack영역의 변수 name에 번지 저장
		...
		String name2 = new String("이왕재");
		System.out.println(name2);
		System.out.println(name == name2);//stack 값을 비교
		System.out.println(name.equals(name2));//heap을 비교
		// String 값 비교는 무조건 equals()를 사용하자!
		
		String name3 = "이왕재";
		System.out.println(name == name3);
		// String의 경우 값이 같으면 번지를 재활용하는 경우도 있다
		// 그래도 equals() 쓰자
		
		String name4 = "이" + "왕재";
		System.out.println(name == name4);
		// "이" 따로 "왕재" 따로 heap에 생기고
		// 더한 결과가 따로 생김(그런데 String이라서 주소 재활용)
		
		String name5 = name;
		System.out.println(name5);
		System.out.println(name5 == name);
		name = "다른걸로";
		System.out.println(name5);	// 이왕재
		System.out.println(name5 == name); //false
		
//		int c = null;
		// primitive 타입에는 null이 들어갈 수 없다
